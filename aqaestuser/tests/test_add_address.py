...
class TestNow(TestDriver):
    def test_add_address_with_select_state(self, first_name, last_name, email, password):
        CreateAccountPage(self.driver).create(first_name, last_name, email, password)
        page = AddressAddPage(self.driver)
    ...
    def test_add_address_with_input_state(self, first_name, last_name, email, password):
        CreateAccountPage(self.driver).create(first_name, last_name, email, password)
        page = AddressAddPage(self.driver)
        page.company = self.company
        page.telephone = self.phone_number
